...
This section describes methods for uploading the cropping calendar for the older **ACAP 1.0**. Its last stable version is Release/Tag version [**9.5.6**](https://github.com/amia-cis/climate-services-webportal-v1/releases/tag/v9.5.6), accessible in the **climate-services-webportal-v1** repository.
