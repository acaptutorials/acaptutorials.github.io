...
<Callout type="warning">
The **crop stage codes** should match with the **crop stage codes** defined in the **crop recommendations** raw Excel file to ensure the correct association of crop stages with target recommendations.
</Callout>
