...
![search bar keywords](https://raw.githubusercontent.com/acaptutorials/acaptutorials.github.io/assets/images/meta/meta_site_search.png)
...
- If there are no errors in the previous step, type keyword(s) from the sample **About Us** page in the **Search Bar**, eg.,
   ...
   ![site search success](https://raw.githubusercontent.com/acaptutorials/acaptutorials.github.io/assets/images/site_search_success.png)
