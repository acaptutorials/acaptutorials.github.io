...
Given time and availability, code Maintainers (old and new) with access to the ACAP code repositories and who are acquainted with its latest updates events will try to update this documentation website as frequently as possible to sync with the latest updates in the codebase.